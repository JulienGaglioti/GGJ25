...
public class Bubble : MonoBehaviour
{
    ...
    public float Oxygen
    {
        ...
        {
            this.value = value;
            transform.localScale = Vector3.one * ((float)Math.Max(0, Math.Log(Math.Max(0, this.value/10f) + 1) * multiplier) + scaleOffset);
    ...
    [SerializeField] protected float scaleOffset = 0f;
